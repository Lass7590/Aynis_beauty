               ...
               <div class="col-lg-12 d-block">
                  <div class="row d-flex">
                     <div class="col-md pr-4 d-flex topper align-items-center">
                        ...
                        <span class="text">+221 77 900 75 60</span>
                     </div>
                     <div class="col-md pr-4 d-flex topper align-items-center">
         ...
         <header class="header_section">
            <div class="container">
               <nav class="navbar navbar-expand-lg custom_nav-container ">
                  <a class="navbar-brand" href="{{URL::to('/')}}"><img width="75" src="images/logo1.png" alt="#" /></a>
                     ...
                     <ul class="navbar-nav">
                       ...
                       <li class="nav-item dropdown">
                           ...
                           <ul class="dropdown-menu">
                              <li><a href="about.html">Teint Clair</a></li>
                              <li><a href="testimonial.html">Teint Noir</a></li>
                           </ul>
                        </li>
                        <li class="nav-item">
                           <a class="nav-link" href="{{URL::to('/product')}}">Produits</a>
                        </li>
                        {{-- <li class="nav-item">
               ...
               <div class="col-md-4">
                   <div class="full">
                      ...
                      <div class="information_f">
                        <p><strong>ADDRESSE :</strong> Keur Massar Unité 6</p>
                        <p><strong>TELEPHONE :</strong> +221 77 900 75 60</p>
